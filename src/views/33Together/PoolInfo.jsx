      ...
      <Paper className="ogv-card">
          ...
          <>
            <Box display="flex" flexDirection="column" className="user-pool-data">
              ...
              <div className="data-row">
                ...
                <Typography>{props.isAccountLoading ? <Skeleton width={100} /> : props.sogvBalance} sOGV</Typography>
              </div>
            </Box>
        ...
        <Box display="flex" flexDirection="column" className="pool-data">
          ...
          <div className="data-row">
            ...
            <Typography>
              {props.graphLoading ? <Skeleton width={100} /> : props.totalDeposits.toLocaleString()} sOGV
            </Typography>
          </div>
          <div className="data-row">
            <Typography>
            ...
            <Typography>
              {props.graphLoading ? <Skeleton width={100} /> : props.totalSponsorship.toLocaleString()} sOGV
            </Typography>
          </div>
          <div className="data-row">
            <Typography>
          ...
          <div className="data-row">
            ...
            <Box display="flex" alignItems="center">
              <Typography>OlygiveDAO</Typography>
            </Box>
          </div>
          <Divider color="secondary" />
          <div className="data-row">
