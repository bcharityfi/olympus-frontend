...
function ZapInfo({ tokens, address }) {
  ...
  return (
    <>
      <Paper className="ogv-card" id="olyzaps-info">
        <Grid container direction="row" wrap spacing={4}>
          ...
          <Grid item sm={12} md={4} classes={{ root: classes.infoBox, item: classes.infoBoxItem }}>
            ...
            <Box classes={{ root: classes.infoBody }}>
              ...
              <Typography align="left" variant="body2" className="oly-info-body">
                <Trans>OlyZap reduces complexity, saves you time and keeps you here on Olygive.</Trans>
              </Typography>
            </Box>
          </Grid>
          <Grid item sm={12} md={4} classes={{ root: classes.infoBox, item: classes.infoBoxItem }}>
            ...
            <Box classes={{ root: classes.infoBody }}>
              ...
              <Typography align="left" variant="body2" className="oly-info-body">
                <Trans>
                  Staking is the primary value accrual strategy of Olygive. When you stake, you lock OGV and receive an
                  equal amount of sOGV.
                </Trans>
              </Typography>
            </Box>
          </Grid>
        ...
        <Box className="button-box">
          <Button
            variant="outlined"
            color="secondary"
            href="https://docs.olygivedao.finance/main/using-the-website/olyzaps"
            target="_blank"
